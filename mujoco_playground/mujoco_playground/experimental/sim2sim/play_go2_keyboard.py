...
from mujoco_playground.experimental.sim2sim.keyboard_reader import KeyboardController
...
class OnnxController:
  ...
  def get_obs(self, model, data) -> np.ndarray:
    ...
    # linvel = np.zeros_like(data.sensor("local_linvel").data)
...
def load_callback(model=None, data=None):
  ...
  policy = OnnxController(
      policy_path=(_ONNX_DIR / "go2_policy_no_lin_vel.onnx").as_posix(),
