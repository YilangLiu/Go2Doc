...
def brax_ppo_config(env_name: str) -> config_dict.ConfigDict:
  ...
  elif env_name in ("Go2Handstand", "Go2Footstand", "Go2Flip", "Go2FlipRL", "Go2RestoreRL"):
    rl_config.num_timesteps = 150_000_000 # 100_000_000
    rl_config.num_evals = 5
    rl_config.network_factory = config_dict.create(
        policy_hidden_layer_sizes=(512, 256, 128),
        value_hidden_layer_sizes=(512, 256, 128),
...
def rsl_rl_config(env_name: str) -> config_dict.ConfigDict:
  ...
  if env_name in ("Go2Handstand", "Go2Footstand"):
    rl_config.max_iterations = 50000
